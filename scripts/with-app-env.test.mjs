...
test("the template ships auth off", { skip: !HAS_APP_ENV }, () => {
...
test("the wrapped command runs with the app env applied", { skip: !HAS_APP_ENV }, async () => {
...
test("the CLI still runs when invoked through a symlinked path", { skip: !HAS_APP_ENV }, async () => {
